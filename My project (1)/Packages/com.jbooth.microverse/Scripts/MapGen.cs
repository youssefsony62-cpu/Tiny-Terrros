...
namespace JBooth.MicroVerseCore
{
    public class MapGen
    {
        ...
        public static RenderTexture QuadCombine(Terrain t, Dictionary<Terrain, RenderTexture> tempRenderData, int borderPixels = 32)
        {
            ...
            var expandedRT = RenderTexture.GetTemporary(myMask.width + borderPixels * 2, myMask.height + borderPixels * 2, 0, myMask.graphicsFormat);
        ...
        public static RenderTexture GenerateFlowMap(Terrain t, Dictionary<Terrain, RenderTexture> heights)
        {
            ...
            var heightMap = RenderTexture.GetTemporary(outputSize, outputSize, 0, heightMapQ.graphicsFormat);
