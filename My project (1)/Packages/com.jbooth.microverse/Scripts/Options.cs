...
namespace JBooth.MicroVerseCore
{
    ...
    public class Options
    {
        ...
        public class Settings
        {
            ...
            [Tooltip("Opt-out of this option if your third party renderer wants to controll the \"Draw Trees&Details\" option.")]
            public bool controllFoliageDraw = true;
            ...
            [Tooltip("Disable this, if you experience crashes related to terrain holes, when you save your scene.")]
            public bool SyncHolesOnSave = true;
        }
